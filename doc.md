...
When receiving a bracketed-paste start control sequence from the terminal,
will interpet this as a request to do `:paste` command and
ignore actual pasted input until the end control sequence
